...
<script type="text/javascript" src="${rootURL}resources/js/newUserQuestions.js"></script>
</head>
...
<center>
<div id="errorDiv"></div>
 username : <input type="text" name="un" id="username" value="abc"/><br>		
...
<%@ include file="registrationCreateBucket.jsp" %>
</div>
